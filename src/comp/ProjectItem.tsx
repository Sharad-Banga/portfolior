...
export default function ProjectItem({imageUrl , Title , description ,width}:projectInter){
  return(
    <>  
      ...
      <div className="w-[98%] h-[150px] flex justify-evenly items-center  bg-black/5 dark:bg-white/5  rounded-sm border dark:border-white/20 border-black/20 dark:hover:bg-white/10 mb-4">
              ...
              <div className="flex justify-between items-center w-[96%]">
                <div className=" text-[30px] font-sans text-black/70 font-semibold dark:text-white" >
                  ...
                  <div className="flex w-[10%] text-[12px]   gap-1  justify-between items-center">
                    <div className="rounded-2xl text-black dark:text-white "> Live</div>
                    <div>
                      <svg className=" rounded-2xl fill-black dark:fill-white"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 30 30">
