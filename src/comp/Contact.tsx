    ...
    <>
      ...
      <div className="mt-32  flex flex-col items-center dark:text-white text-black">
        ...
        <div className="flex justify-between items-center w-[40%]">
                <div className='mt-10 mb-10 p-1 sm:h-[34px] sm:w-[34px] h-[24px] w-[24px] flex justify-center items-center bg-white text-white rounded-md text-[140%] border border-white/15 hover:scale-110 transition-all ease-in-out'><a href="https://x.com/sharad_banga" target="_blank" rel="noopener noreferrer">
        ...
        <div className="flex justify-between items-center w-[40%]">
            <div className='mt-10 mb-10 p-1 sm:h-[35px] h-[27px] w-[26px] sm:w-[36px] flex justify-center items-center bg-black  text-white rounded-md hover:scale-110 transition-all ease-in-out'><a href="https://github.com/Sharad-Banga" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='am:w-[35px] am:h-[32px] w-[28px] h-[30px]'  viewBox="0,0,256,256">
        ...
        <div className="flex justify-between items-center w-[40%]">
              <div className='mt-10 mb-10 p-1 sm:h-[25px] sm:w-[33px] w-[24px] h-[26px] flex justify-center items-center bg-white text-white rounded-sm hover:scale-110 transition-all ease-in-out'><a href="https://www.linkedin.com/in/sharad-banga-37a83a248/" target="_blank" rel="noopener noreferrer">
        ...
        <div className="flex justify-between items-center w-[40%]">
            <div className='mt-10 mb-10 p-1 sm:h-[35px] h-[26px] sm:w-[34px] w-[25px] flex justify-center items-center bg-black text-white rounded-sm hover:scale-110 transition-all ease-in-out'><a href="https://leetcode.com/u/Sharad_Banga/" target="_blank" rel="noopener noreferrer">
