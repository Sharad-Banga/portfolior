  ...
  return (
    <div className='flex flex-col  justify-start items-start  w-full h-full pt-24 sm:pt-32'>
      ...
      <div className='flex sm:flex-row flex-col-reverse justify-start items-start sm:justify-between sm:pl-4  sm:items-center h-[200px] sm:h-[170px]   w-full sm:p-[10px] '>
        ...
        <div className="sm:h-[90%] sm:w-[19%]  h-[60%] w-full  rounded-full flex justify-center items-center sm:mr-10 hover:scale-110 mt-4 transition-all ease-in-out">
          <img src="/images/dp.png" alt="" className=" w-[30%] hover:rotate-1 transition-transform ease-in-out -rotate-1 cursor-pointer sm:w-[155%] h-[100%]  object-cover rounded-lg  sm:rounded-2xl origin-top" />
