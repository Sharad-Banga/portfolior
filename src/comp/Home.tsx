...
export default function Home() {
  return (
    <div className='flex flex-col  justify-start items-start  w-full h-full pt-24 sm:pt-32'>
      ...
      <div className='flex sm:flex-row flex-col-reverse justify-start items-start sm:justify-between sm:pl-4 sm:pl-10 sm:items-center h-[200px] sm:h-[170px]   w-full p-[10px] '>
        <div>
          <div className='sm:text-[200%] font-bold text-[120%] w-[180%] flex justify-center sm:justify-start  dark:text-green-300'>
            SHARAD BANGA
          </div>
          <div className='text-black/70 font-semibold text-[70%] sm:text-[100%] dark:text-white/70 flex justify-center w-[180%] sm:justify-start'>
            Software Engineer
          </div>
          <div className=' flex justify-center sm:justify-start gap-1 sm:gap-2 sm:w-[66%] w-[180%] mt-3 items-center   sm:p-1 rounded-md '>
            <div className='p-1 sm:h-[34px] sm:w-[34px] h-[24px] w-[24px] flex justify-center items-center bg-white text-white rounded-md text-[140%] border border-white/15 hover:scale-110 transition-all ease-in-out'><a href="https://x.com/sharad_banga">
            ...
            <div className='p-1 sm:h-[35px] h-[27px] w-[26px] sm:w-[36px] flex justify-center items-center bg-black  text-white rounded-md hover:scale-110 transition-all ease-in-out'><a href="">
...
<g fill="#ffffff" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none" style={{mixBlendMode: "normal"}}><g transform="scale(4,4)"><path d="M32,10c-12.15,0 -22,9.85 -22,22c0,12.15 9.85,22 22,22c12.15,0 22,-9.85 22,-22c0,-12.15 -9.85,-22 -22,-22zM32,14c9.941,0 18,8.059 18,18c0,8.23871 -5.54128,15.16934 -13.0957,17.30664c-0.0928,-0.19124 -0.15645,-0.40072 -0.15039,-0.63867c0.031,-1.209 0,-4.03041 0,-5.06641c0,-1.778 -1.125,-3.03906 -1.125,-3.03906c0,0 8.82422,0.09959 8.82422,-9.31641c0,-3.633 -1.89844,-5.52539 -1.89844,-5.52539c0,0 0.9973,-3.87844 -0.3457,-5.52344c-1.505,-0.163 -4.20056,1.43755 -5.35156,2.18555c0,0 -1.82342,-0.74805 -4.85742,-0.74805c-3.034,0 -4.85742,0.74805 -4.85742,0.74805c-1.151,-0.748 -3.84656,-2.34755 -5.35156,-2.18555c-1.342,1.645 -0.3457,5.52344 -0.3457,5.52344c0,0 -1.89844,1.89044 -1.89844,5.52344c0,9.416 8.82422,9.31836 8.82422,9.31836c0,0 -1.00476,1.14381 -1.10547,2.7832c-0.58969,0.20793 -1.39349,0.45313 -2.16016,0.45313c-1.85,0 -3.25548,-1.79691 -3.77148,-2.62891c-0.508,-0.821 -1.54948,-1.50977 -2.52148,-1.50977c-0.64,0 -0.95312,0.3215 -0.95312,0.6875c0,0.366 0.89823,0.62083 1.49023,1.29883c1.248,1.43 1.22488,4.64648 5.67188,4.64648c0.5258,0 1.47056,-0.1211 2.22461,-0.22461c-0.00417,1.00955 -0.0159,1.97778 0,2.59766c0.00586,0.23869 -0.05897,0.44894 -0.15234,0.64063c-7.55349,-2.1379 -13.09375,-9.0686 -13.09375,-17.30664c0,-9.941 8.059,-18 18,-18z"></path></g></g>
            ...
            <div className='p-1 sm:h-[25px] sm:w-[33px] w-[24px] h-[26px] flex justify-center items-center bg-white text-white rounded-sm hover:scale-110 transition-all ease-in-out'><a href="">
    ...
    <path d="M41,4H9C6.24,4,4,6.24,4,9v32c0,2.76,2.24,5,5,5h32c2.76,0,5-2.24,5-5V9C46,6.24,43.76,4,41,4z M17,20v19h-6V20H17z M11,14.47c0-1.4,1.2-2.47,3-2.47s2.93,1.07,3,2.47c0,1.4-1.12,2.53-3,2.53C12.2,17,11,15.87,11,14.47z M39,39h-6c0,0,0-9.26,0-10 c0-2-1-4-3.5-4.04h-0.08C27,24.96,26,27.02,26,29c0,0.91,0,10,0,10h-6V20h6v2.56c0,0,1.93-2.56,5.81-2.56 c3.97,0,7.19,2.73,7.19,8.26V39z"></path>
            ...
            <div className='p-1 sm:h-[35px] h-[26px] sm:w-[34px] w-[25px] flex justify-center items-center bg-black text-white rounded-sm hover:scale-110 transition-all ease-in-out'><a href="">
        ...
        <div className="sm:h-[90%] sm:w-[16%] w-[30%] h-[60%] ml-24  bg-red-400 rounded-full flex justify-center items-center mr-10 hover:scale-110 mt-4 transition-all ease-in-out">
          <img src="/images/dp4.jpg" alt="" className="sm:w-[105%] sm:h-[100%]  object-cover rounded-2xl origin-top" />
        </div>
      ...
      <div className=" flex justify-center items-center pl-4 sm:pl-12 mt-4 sm:mt-16">
